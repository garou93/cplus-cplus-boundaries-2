// (c) Saadouli ben abdelaziz haythem. All Rights Reserved.
// for any information: haithem.ben.abdelaziz@gmail.com
#include <iostream>
#include <iomanip>
#include <list>
...
int main()
{
    list<Student> studentBody;   // instanciate list
    Student s1("KO", "Fal", 'M', "Ms.", 3.8, "C++", "117PSU");
    ...
    studentBody.push_back(Student("ger_tamem", "Sato", 'U', "Dr.", 3.8, "C++", "178PSU")); 
    studentBody.push_back(Student("eng_fe-sing", "Kato", 'B', "Dr.", 3.9, "C++", "272PSU")); 
    studentBody.push_back(Student("p1_p2-not-res_parceque", "LeBrun", 'R', "Ms.", 3.4, "C++", "299TU")); 
    ...
    delete s2;  // you must still delete an object which you have allocated on the heap
