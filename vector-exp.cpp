...
int main()
{
    ...
    studentBody1.push_back(Student("Soulef", "nofinger", 'U', "Dr.", 3.8, "C++", "178PSU"));
    studentBody1.push_back(Student("khadija", "Kisako", 'B', "Dr.", 3.9, "C++", "272PSU"));
    studentBody1.push_back(Student("Ruby", "LeBrun", 'R', "Ms.", 3.4, "C++", "299TU"));
